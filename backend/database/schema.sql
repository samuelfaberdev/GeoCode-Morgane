...
INSERT INTO user (nom, prenom, rue, code_postal,ville, email, password, connection, nb_vehicule, admin, anniversaire, inscription, derniere_maj)
 VALUES('debarge', 'morgane', 'rue dupont', 75000, 'Arnac', 'morgane@debarge.fr', '$argon2id$v=19$m=19456,t=2,p=1$AHLIs9tC/Ye3lBxqGrz57A$svfAn+6veHtuvvce+dx9k1FZ+8GXamO8MM0elTLlpwQ', '2023-01-09', 1, true, '1990-01-01', '2023-01-09', '2023-01-09'),
 ('save', 'baptiste', 'rue dupont', 75000, 'Arnac', 'baptiste@save.fr', '$argon2id$v=19$m=19456,t=2,p=1$HOGUQPHnC3WlYLTydsjYzA$4WC83lpS5gcmDY+BC3pO0TtzY5kE44hYE3B8BnXhVn0', '2023-01-09', 1, true, '1990-01-01', '2023-01-09', '2023-01-09'),
 ('foulon', 'raphael', 'rue dupont', 75000, 'Arnac', 'raphael@foulon.fr', '$argon2id$v=19$m=19456,t=2,p=1$H66tZbWq7npkmuCZ7d0u4g$1pl9ttBn48SwqktvlwM2qA/YGCoEJy+0bGzol9TuZjg', '2023-01-09', 1, true, '1990-01-01', '2023-01-09', '2023-01-09'),
 ('illien', 'jeremy', 'rue dupont', 75000, 'Arnac', 'jeremy@illien.fr', '$argon2id$v=19$m=19456,t=2,p=1$i8Rox6tnfRoG5BFZTg8cfA$rcvzkFE1hCFMMQMt4XDyVGaQSb7sriIztN0dN3GGe68', '2023-01-09', 1, true, '1990-01-01', '2023-01-09', '2023-01-09');
